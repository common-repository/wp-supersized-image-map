...
(function($){
    ...
    $.supersized = function(options){
    	...
    	base._start = function(){
			...
			// Set current image
			var next_map = "#imgmap_" + api.getField('title');
			imageLink = (api.getField('url')) ? "href='" + api.getField('url') + "'" : "";
			var img = $('<img usemap="' + next_map + '" src="'+api.getField('image')+'" />');
			...
			if (base.options.slides.length > 1){
				...
				var imgNext = $('<img usemap="' + next_map + '" src="'+base.options.slides[loadNext].image+'"  />');
    ...
    /* Resize Images
		...
		base.resizeNow = function(){
			...
			return base.$el.each(function() {
              ...
              //var v = $('#hotspots_14 .link13').css("top");
